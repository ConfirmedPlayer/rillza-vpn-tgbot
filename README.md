...
> Проект в разработке. Готовы этапы 1–5: каркас и CI, база данных,
> клиент панели CELERITY, пробный период с экраном подписки и
> инструкцией подключения, оплата через ЮMoney и CryptoBot.
> Дальше — админка и рассылки, по порядку из PLAN.md §14.
...
`PANEL_API_KEY`. Оплата включается наличием ключей: `YOOMONEY_ACCESS_TOKEN`

...
> Проект в разработке. Готовы этапы 1–4: каркас и CI, база данных,
> клиент панели CELERITY, пробный период с экраном подписки и
> инструкцией подключения. Дальше — платежи, по порядку из PLAN.md §14.
...
├── services/       unit of work, подписки, пробный период
├── integrations/   клиент панели CELERITY

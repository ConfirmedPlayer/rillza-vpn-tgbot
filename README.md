...
> Проект в разработке. Готовы этапы 1–6: каркас и CI, база данных,
...
> с рассылками и напоминания об истечении. Дальше — анонимная
> поддержка, по порядку из PLAN.md §14.
...
│                   рассылки, уведомления, статистика

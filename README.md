...
> Проект в разработке. Готовы этапы 1–7: каркас и CI, база данных,
> клиент панели CELERITY, пробный период с экраном подписки и
> инструкцией подключения, оплата через ЮMoney и CryptoBot, админка
> с рассылками и напоминаниями, анонимная поддержка. Остался
> финальный этап: реконсилятор, runbook и удаление старого `src/`.
...
├── services/       unit of work, подписки, триал, платежи,
│                   рассылки, уведомления, поддержка

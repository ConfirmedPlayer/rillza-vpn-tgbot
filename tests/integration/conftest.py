...
SEED_TARIFFS = (
    ...
    ('m1', '1 месяц · до 2 устройств', 30, 20_000, 2, 1),
    ('m3', '3 месяца · до 2 устройств', 90, 54_000, 2, 2),
    ('m6', '6 месяцев · до 2 устройств', 180, 96_000, 2, 3),
    ('m12', '12 месяцев · до 2 устройств', 365, 168_000, 2, 4),
